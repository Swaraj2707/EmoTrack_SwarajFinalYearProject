...
// import '../../../../css/styles/pages/daily-activities/DailyActivities.scss';
    ...
    return (
        <Box className="dailyActivities">
            <Tabs value={tabIndex} onChange={handleTabChange} variant="fullWidth">
                ...
                <Tab label="Exercise Tracker" icon={<FontAwesomeIcon icon={faDumbbell} />} />
            </Tabs>
