...
//             }
//             value = {
//                 (this.props.waterLevel / this.props.goal) * 100
//             }
//             textSize = {
//                 1
//             }
...
//                             valueStyle
//                         } > {
//                             this.props.waterLevel
//                         } < /tspan> <
//                         tspan style = {
//                             percentStyle
//                         } > /{this.props.goal}</tspan >
//                         <
//                         tspan > Glasses < /tspan> <
//                         /tspan>
//                     );
//                 }
//             }
//             riseAnimation waveAnimation waveFrequency = {
//                 2
//             }
//             waveAmplitude = {
//                 1
...
class WaterLevel extends Component {
    ...
    render() {
        const radius = 100;
        const interpolate = interpolateRgb(this.startColor, this.endColor);
        const fillColor = interpolate(this.props.waterLevel / this.props.goal);
        const gradientStops = [
            {
                key: '0%',
                stopColor: color(fillColor).darker(0.5).toString(),
