...
import '../../../../css/styles/pages/Dashboard.scss';
...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        const body = (url, time) => ({
            ...
            "bucketByTime": {
                "durationMillis": time.durationTime
            },
    ...
    return (
        <Grid container direction="column" justifyContent="flex-start" alignItems="flex-start" className="dashboard">
            <Grid item sx={{ mb: 3 }}>
