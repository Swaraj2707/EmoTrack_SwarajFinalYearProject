    ...
    return (
        <Card variant="outlined" className="whiteBox weekly-stat-card">
            <Box className="container-box">
                <Box className="whiteBox chart-box" sx={{ backgroundColor: "#ffffff", width: "100%" }}>
                    <Graph graphData={chartData[obj.key]} color={obj.color} type={type} />
                </Box>
                <Box className="title-box">{type === "weekly" ? "Current Week Stats" : "Current Month Stats"}</Box>
            </Box>
        </Card>
    );
}

const StatDetails = ({ activeStat }) => {
    ...
    return (
        <Grid container direction="row" justifyContent="flex-start" alignItems="center" className="weekly-stats">
            <Grid item key={`statDetails-weekly`} xs={12} sm={6}>
                {GraphCard({ obj: activeStat, type: "weekly", chartData: chartWeeklyData })}
            </Grid>
            <Grid item key={`statDetails-monthly`} xs={12} sm={6}>
                {GraphCard({ obj: activeStat, type: "monthly", chartData: chartMonthlyData })}
            </Grid>
        </Grid>
    );
}
...
//         className = "whiteBox weekly-stat-card" >
//         <
//         Box className = "container-box" >
//         <
...
//             6
//         } > {
//             GraphCard(activeStat, "weekly", chartWeeklyData)
//         } < /Grid> <
//         Grid item key = {
//             `statDetails-monthly`
//         }
...
//             6
//         } > {
//             GraphCard(activeStat, "monthly", chartMonthlyData)
//         } < /Grid> <
//         /Grid>
//     );
// }
